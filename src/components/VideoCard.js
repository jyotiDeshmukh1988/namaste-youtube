...
const VideoCard = ({ info,isRecommended }) => {
  ...
  return (
    <>
      <div className={isRecommended ? "flex flex-row gap-2" :"text-sm"}>
        <div className={isRecommended ? "relative w-1/2" :"relative"}>
          <img
        ...
        <div className={isRecommended ? "flex gap-1 flex-col w-1/2" :"flex gap-1 flex-col"}>
